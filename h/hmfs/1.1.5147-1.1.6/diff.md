# Comparing `tmp/hmfs-1.1.5147.tar.gz` & `tmp/hmfs-1.1.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "hmfs-1.1.5147.tar", last modified: Sun Jul 30 04:37:42 2023, max compression
+gzip compressed data, was "dist/hmfs-1.1.6.tar", last modified: Wed Aug 24 12:07:38 2022, max compression
```

## Comparing `hmfs-1.1.5147.tar` & `hmfs-1.1.6.tar`

### file list

```diff
@@ -1,41 +1,1134 @@
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-07-30 04:37:42.979571 hmfs-1.1.5147/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      330 2023-07-30 04:37:42.979571 hmfs-1.1.5147/PKG-INFO
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-07-30 04:37:42.971571 hmfs-1.1.5147/hamunafs/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        0 2023-03-08 01:38:33.000000 hmfs-1.1.5147/hamunafs/__init__.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-07-30 04:37:42.971571 hmfs-1.1.5147/hamunafs/backends/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      203 2023-03-08 01:38:33.000000 hmfs-1.1.5147/hamunafs/backends/__init__.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     1106 2023-07-13 15:10:25.000000 hmfs-1.1.5147/hamunafs/backends/base.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4042 2023-07-13 15:10:25.000000 hmfs-1.1.5147/hamunafs/backends/bk_minio.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4374 2023-07-13 15:10:25.000000 hmfs-1.1.5147/hamunafs/backends/bk_qiniu.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     1233 2023-03-08 01:38:33.000000 hmfs-1.1.5147/hamunafs/backends/bk_share.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     5771 2023-07-13 15:10:25.000000 hmfs-1.1.5147/hamunafs/backends/bk_wy.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     1436 2023-07-13 15:11:40.000000 hmfs-1.1.5147/hamunafs/backends/fetcher.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)    21042 2023-07-30 04:28:25.000000 hmfs-1.1.5147/hamunafs/client.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      189 2023-03-08 01:38:33.000000 hmfs-1.1.5147/hamunafs/conf.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-07-30 04:37:42.971571 hmfs-1.1.5147/hamunafs/net/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        0 2023-07-13 15:10:25.000000 hmfs-1.1.5147/hamunafs/net/__init__.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     3969 2023-07-13 15:10:25.000000 hmfs-1.1.5147/hamunafs/net/api.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     9177 2023-07-30 03:03:57.000000 hmfs-1.1.5147/hamunafs/server.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-07-30 04:37:42.971571 hmfs-1.1.5147/hamunafs/sqlite/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4895 2023-03-08 01:38:33.000000 hmfs-1.1.5147/hamunafs/sqlite/__init__.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-07-30 04:37:42.975571 hmfs-1.1.5147/hamunafs/tuchuang/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        0 2023-07-13 15:10:25.000000 hmfs-1.1.5147/hamunafs/tuchuang/__init__.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4126 2023-07-13 15:10:25.000000 hmfs-1.1.5147/hamunafs/tuchuang/tucang.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-07-30 04:37:42.979571 hmfs-1.1.5147/hamunafs/utils/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        0 2023-03-08 01:38:33.000000 hmfs-1.1.5147/hamunafs/utils/__init__.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     5300 2023-03-08 01:38:33.000000 hmfs-1.1.5147/hamunafs/utils/cachemanager.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4578 2023-03-08 01:38:33.000000 hmfs-1.1.5147/hamunafs/utils/img_compressor.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4367 2023-07-30 01:58:33.000000 hmfs-1.1.5147/hamunafs/utils/minio.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     3579 2023-03-08 01:38:33.000000 hmfs-1.1.5147/hamunafs/utils/mqtt.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     5226 2023-03-08 01:38:33.000000 hmfs-1.1.5147/hamunafs/utils/nsqmanager.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)    17412 2023-07-13 15:10:25.000000 hmfs-1.1.5147/hamunafs/utils/redisutil.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      633 2023-03-08 01:38:33.000000 hmfs-1.1.5147/hamunafs/utils/singleton_wrapper.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      932 2023-03-08 01:38:33.000000 hmfs-1.1.5147/hamunafs/utils/timeutil.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-07-30 04:37:42.979571 hmfs-1.1.5147/hmfs.egg-info/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      330 2023-07-30 04:37:42.000000 hmfs-1.1.5147/hmfs.egg-info/PKG-INFO
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      864 2023-07-30 04:37:42.000000 hmfs-1.1.5147/hmfs.egg-info/SOURCES.txt
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        1 2023-07-30 04:37:42.000000 hmfs-1.1.5147/hmfs.egg-info/dependency_links.txt
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      141 2023-07-30 04:37:42.000000 hmfs-1.1.5147/hmfs.egg-info/requires.txt
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        9 2023-07-30 04:37:42.000000 hmfs-1.1.5147/hmfs.egg-info/top_level.txt
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)       38 2023-07-30 04:37:42.983571 hmfs-1.1.5147/setup.cfg
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      723 2023-07-30 04:37:35.000000 hmfs-1.1.5147/setup.py
...
### Comparing `hmfs-1.1.5147/hamunafs/backends/bk_minio.py` & `hmfs-1.1.6/hamunafs/backends/bk_minio.py`
...
### Comparing `hmfs-1.1.5147/hamunafs/backends/bk_wy.py` & `hmfs-1.1.6/hamunafs/backends/bk_qiniu.py`
...
### Comparing `hmfs-1.1.5147/hamunafs/client.py` & `hmfs-1.1.6/hamunafs/client.py`
...
### Comparing `hmfs-1.1.5147/hamunafs/server.py` & `hmfs-1.1.6/hamunafs/server.py`
...
-
-from funboost import patch_frame_config, BrokerEnum, boost as task_deco
-from funboost.consumers.base_consumer import ExceptionForRequeue
-
-from hamunafs.utils.cachemanager import CacheManagerAsync
+from function_scheduling_distributed_framework import fsdf_background_scheduler, task_deco, patch_frame_config, get_publisher, BrokerEnum
+from function_scheduling_distributed_framework.consumers.base_consumer import ExceptionForRequeue
...
-minio = MinioAgent('{}:{}'.format(opt.host, opt.port), opt.acs_key,
-                   opt.acs_secret, secure=False, location=opt.location)
 
-cache_engine = CacheManagerAsync(
...
-hmfs_client = FSClient(opt.api_host, cache_engine.client, None)
-
...
-    if await cache_engine.get_cache(key, return_obj=False) is not None:
...
-            if ret:
-                await cache_engine.cache('tmp_file_{}_{}'.format(bucket, bucket_name), {
-                    'ret': True,
-                    'url': url
-                }, expired=24 * 60 * 60)
-                print('upload success!!')
...
-                'err': '文件中转错误'
-            }, expired=60)
-        await cache_engine.cache(key, 1, expired=60)
-    except Exception as e:
-        await cache_engine.cache('tmp_file_{}_{}'.format(bucket, bucket_name), {
-            'ret': False,
-            'err': '锁错误'
...
-        await cache_engine.cache(task_id, {
...
-            ret, e = minio.delete(bucket, bucket_name, 0)
...
### Comparing `hmfs-1.1.5147/hamunafs/sqlite/__init__.py` & `hmfs-1.1.6/hamunafs/sqlite/__init__.py`

 * *Files identical despite different names*

### Comparing `hmfs-1.1.5147/hamunafs/utils/cachemanager.py` & `hmfs-1.1.6/hamunafs/utils/cachemanager.py`

 * *Files identical despite different names*

### Comparing `hmfs-1.1.5147/hamunafs/utils/mqtt.py` & `hmfs-1.1.6/hamunafs/utils/mqtt.py`

 * *Files identical despite different names*

### Comparing `hmfs-1.1.5147/hamunafs/utils/nsqmanager.py` & `hmfs-1.1.6/hamunafs/utils/nsqmanager.py`
...
### Comparing `hmfs-1.1.5147/hamunafs/utils/redisutil.py` & `hmfs-1.1.6/hamunafs/utils/redisutil.py`
...
### Comparing `hmfs-1.1.5147/setup.py` & `hmfs-1.1.6/setup.py`
