# Comparing `tmp/pibble-0.6.5.tar.gz` & `tmp/pibble-0.6.6.tar.gz`
...
### Comparing `pibble-0.6.5/pibble/api/client/webservice/rpc/base.py` & `pibble-0.6.6/pibble/api/client/webservice/rpc/base.py`
...
### Comparing `pibble-0.6.5/pibble/api/helpers/store.py` & `pibble-0.6.6/pibble/api/helpers/store.py`
...
### Comparing `pibble-0.6.5/pibble/database/util.py` & `pibble-0.6.6/pibble/database/util.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/cms/database/__init__.py` & `pibble-0.6.6/pibble/ext/cms/database/__init__.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/cms/database/interface.py` & `pibble-0.6.6/pibble/ext/cms/database/interface.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/cms/database/menu.py` & `pibble-0.6.6/pibble/ext/cms/database/menu.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/cms/database/view.py` & `pibble-0.6.6/pibble/ext/cms/database/view.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/cms/middleware.py` & `pibble-0.6.6/pibble/ext/cms/middleware.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/cms/server/base.py` & `pibble-0.6.6/pibble/ext/cms/server/base.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/cms/server/extension.py` & `pibble-0.6.6/pibble/ext/cms/server/extension.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/dam/database/files.py` & `pibble-0.6.6/pibble/ext/dam/database/files.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/rest/server/base.py` & `pibble-0.6.6/pibble/ext/rest/server/base.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/rest/server/user.py` & `pibble-0.6.6/pibble/ext/rest/server/user.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/session/database/session.py` & `pibble-0.6.6/pibble/ext/session/database/session.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/session/server/base.py` & `pibble-0.6.6/pibble/ext/session/server/base.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/user/client/base.py` & `pibble-0.6.6/pibble/ext/user/client/base.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/user/database/__init__.py` & `pibble-0.6.6/pibble/ext/user/database/__init__.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/user/database/authentication.py` & `pibble-0.6.6/pibble/ext/user/database/authentication.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/user/database/notification.py` & `pibble-0.6.6/pibble/ext/user/database/notification.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/user/database/permission.py` & `pibble-0.6.6/pibble/ext/user/database/permission.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/user/database/user.py` & `pibble-0.6.6/pibble/ext/user/database/user.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/ext/user/server/base.py` & `pibble-0.6.6/pibble/ext/user/server/base.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/hooks/aws.py` & `pibble-0.6.6/pibble/hooks/aws.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/media/thumbnail.py` & `pibble-0.6.6/pibble/media/thumbnail.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/resources/retriever.py` & `pibble-0.6.6/pibble/resources/retriever.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/scripts/importcheck.py` & `pibble-0.6.6/pibble/scripts/importcheck.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/scripts/templatefiles.py` & `pibble-0.6.6/pibble/scripts/templatefiles.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/setup.py` & `pibble-0.6.6/pibble/setup.py`
...
### Comparing `pibble-0.6.5/pibble/util/encryption.py` & `pibble-0.6.6/pibble/util/encryption.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/util/files.py` & `pibble-0.6.6/pibble/util/files.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/util/helpers.py` & `pibble-0.6.6/pibble/util/helpers.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/util/imaging.py` & `pibble-0.6.6/pibble/util/imaging.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/util/log.py` & `pibble-0.6.6/pibble/util/log.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/util/numeric.py` & `pibble-0.6.6/pibble/util/numeric.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/util/strings.py` & `pibble-0.6.6/pibble/util/strings.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble/web/scraper.py` & `pibble-0.6.6/pibble/web/scraper.py`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble.egg-info/PKG-INFO` & `pibble-0.6.6/pibble.egg-info/PKG-INFO`
...
### Comparing `pibble-0.6.5/pibble.egg-info/SOURCES.txt` & `pibble-0.6.6/pibble.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/pibble.egg-info/requires.txt` & `pibble-0.6.6/pibble.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `pibble-0.6.5/setup.py` & `pibble-0.6.6/setup.py`
