# Comparing `tmp/py3data-0.3.1.tar.gz` & `tmp/py3data-0.3.2.tar.gz`
...
+gzip compressed data, was "py3data-0.3.2.tar", last modified: Sun Jul 30 11:14:52 2023, max compression
```

## Comparing `py3data-0.3.1.tar` & `py3data-0.3.2.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-30 11:14:52.225382 py3data-0.3.2/
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-30 11:14:52.217381 py3data-0.3.2/.github/
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-30 11:14:52.221382 py3data-0.3.2/.github/workflows/
+-rw-r--r--   0 runner    (1001) docker     (123)      166 2023-07-30 11:14:34.000000 py3data-0.3.2/.github/workflows/python-lint.yml
+-rw-r--r--   0 runner    (1001) docker     (123)      601 2023-07-30 11:14:34.000000 py3data-0.3.2/.github/workflows/python-package.yml
+-rw-r--r--   0 runner    (1001) docker     (123)      623 2023-07-30 11:14:34.000000 py3data-0.3.2/.github/workflows/python-publish.yml
+-rw-r--r--   0 runner    (1001) docker     (123)      491 2023-07-30 11:14:34.000000 py3data-0.3.2/.gitignore
+-rw-r--r--   0 runner    (1001) docker     (123)      309 2023-07-30 11:14:34.000000 py3data-0.3.2/.pre-commit-config.yaml
+-rw-r--r--   0 runner    (1001) docker     (123)      545 2023-07-30 11:14:34.000000 py3data-0.3.2/CITATION.cff
+-rw-r--r--   0 runner    (1001) docker     (123)     1074 2023-07-30 11:14:34.000000 py3data-0.3.2/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (123)     5906 2023-07-30 11:14:52.225382 py3data-0.3.2/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)     5175 2023-07-30 11:14:34.000000 py3data-0.3.2/README.md
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-30 11:14:52.221382 py3data-0.3.2/py3data/
+-rw-r--r--   0 runner    (1001) docker     (123)      337 2023-07-30 11:14:34.000000 py3data-0.3.2/py3data/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)      160 2023-07-30 11:14:52.000000 py3data-0.3.2/py3data/_version.py
+-rw-r--r--   0 runner    (1001) docker     (123)     9075 2023-07-30 11:14:34.000000 py3data-0.3.2/py3data/api.py
+-rw-r--r--   0 runner    (1001) docker     (123)    17994 2023-07-30 11:14:34.000000 py3data-0.3.2/py3data/xmltodict.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-30 11:14:52.225382 py3data-0.3.2/py3data.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     5906 2023-07-30 11:14:52.000000 py3data-0.3.2/py3data.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      436 2023-07-30 11:14:52.000000 py3data-0.3.2/py3data.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-30 11:14:52.000000 py3data-0.3.2/py3data.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       37 2023-07-30 11:14:52.000000 py3data-0.3.2/py3data.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        8 2023-07-30 11:14:52.000000 py3data-0.3.2/py3data.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)     1106 2023-07-30 11:14:34.000000 py3data-0.3.2/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-30 11:14:52.225382 py3data-0.3.2/setup.cfg
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-30 11:14:52.225382 py3data-0.3.2/tests/
+-rw-r--r--   0 runner    (1001) docker     (123)     3669 2023-07-30 11:14:34.000000 py3data-0.3.2/tests/test_api.py
```

### Comparing `py3data-0.3.1/.github/workflows/python-package.yml` & `py3data-0.3.2/.github/workflows/python-package.yml`

 * *Files identical despite different names*

### Comparing `py3data-0.3.1/.github/workflows/python-publish.yml` & `py3data-0.3.2/.github/workflows/python-publish.yml`

 * *Files identical despite different names*

### Comparing `py3data-0.3.1/LICENSE` & `py3data-0.3.2/LICENSE`

 * *Files identical despite different names*

### Comparing `py3data-0.3.1/PKG-INFO` & `py3data-0.3.2/PKG-INFO`
...
### Comparing `py3data-0.3.1/README.md` & `py3data-0.3.2/README.md`
...
### Comparing `py3data-0.3.1/py3data/api.py` & `py3data-0.3.2/py3data/api.py`

 * *Files identical despite different names*

### Comparing `py3data-0.3.1/py3data/xmltodict.py` & `py3data-0.3.2/py3data/xmltodict.py`

 * *Files identical despite different names*

### Comparing `py3data-0.3.1/py3data.egg-info/PKG-INFO` & `py3data-0.3.2/py3data.egg-info/PKG-INFO`
...
### Comparing `py3data-0.3.1/pyproject.toml` & `py3data-0.3.2/pyproject.toml`

 * *Files identical despite different names*

### Comparing `py3data-0.3.1/tests/test_api.py` & `py3data-0.3.2/tests/test_api.py`
