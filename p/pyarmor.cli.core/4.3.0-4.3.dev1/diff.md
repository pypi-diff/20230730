# Comparing `tmp/pyarmor.cli.core-4.3.0.zip` & `tmp/pyarmor.cli.core-4.3.dev1.zip`
...
## Comparing `pyarmor.cli.core-4.3.0/setup.py` & `pyarmor.cli.core-4.3.dev1/setup.py`
