# Comparing `tmp/awyes-10.1.2.tar.gz` & `tmp/awyes-10.1.3.tar.gz`
...
## Comparing `awyes-10.1.2.tar` & `awyes-10.1.3.tar`
...
### Comparing `awyes-10.1.2/PKG-INFO` & `awyes-10.1.3/PKG-INFO`
...
### Comparing `awyes-10.1.2/README.md` & `awyes-10.1.3/README.md`

 * *Files identical despite different names*

### Comparing `awyes-10.1.2/awyes/awyes.py` & `awyes-10.1.3/awyes/awyes.py`
...
### Comparing `awyes-10.1.2/awyes/awyes_test.py` & `awyes-10.1.3/awyes/awyes_test.py`

 * *Files identical despite different names*

### Comparing `awyes-10.1.2/awyes/utils.py` & `awyes-10.1.3/awyes/utils.py`

 * *Files identical despite different names*

### Comparing `awyes-10.1.2/awyes.egg-info/PKG-INFO` & `awyes-10.1.3/awyes.egg-info/PKG-INFO`
...
### Comparing `awyes-10.1.2/setup.py` & `awyes-10.1.3/setup.py`
