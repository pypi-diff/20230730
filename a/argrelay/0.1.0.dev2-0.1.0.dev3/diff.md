# Comparing `tmp/argrelay-0.1.0.dev2.tar.gz` & `tmp/argrelay-0.1.0.dev3.tar.gz`
...
### Comparing `argrelay-0.1.0.dev2/LICENSE` & `argrelay-0.1.0.dev3/LICENSE`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/PKG-INFO` & `argrelay-0.1.0.dev3/PKG-INFO`
...
### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/argrelay_env_var_notes.md` & `argrelay-0.1.0.dev3/docs/dev_notes/argrelay_env_var_notes.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/bootstrap_procedure.1.project_creation.md` & `argrelay-0.1.0.dev3/docs/dev_notes/bootstrap_procedure.1.project_creation.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/bootstrap_procedure.2.initial_deployment.md` & `argrelay-0.1.0.dev3/docs/dev_notes/bootstrap_procedure.2.initial_deployment.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/bootstrap_procedure.3.argrelay_upgrade.md` & `argrelay-0.1.0.dev3/docs/dev_notes/bootstrap_procedure.3.argrelay_upgrade.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/code_style.md` & `argrelay-0.1.0.dev3/docs/dev_notes/code_style.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/completion_notes.md` & `argrelay-0.1.0.dev3/docs/dev_notes/completion_notes.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/completion_perf_notes.md` & `argrelay-0.1.0.dev3/docs/dev_notes/completion_perf_notes.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/how_search_works.md` & `argrelay-0.1.0.dev3/docs/dev_notes/how_search_works.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/mongo_notes.md` & `argrelay-0.1.0.dev3/docs/dev_notes/mongo_notes.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/query_perf_10_x_more_data_notes.md` & `argrelay-0.1.0.dev3/docs/dev_notes/query_perf_10_x_more_data_notes.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/query_perf_cache_vs_no_cache.md` & `argrelay-0.1.0.dev3/docs/dev_notes/query_perf_cache_vs_no_cache.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/query_perf_mongomock_notes.md` & `argrelay-0.1.0.dev3/docs/dev_notes/query_perf_mongomock_notes.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/query_perf_pymongo_notes.md` & `argrelay-0.1.0.dev3/docs/dev_notes/query_perf_pymongo_notes.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/release_procedure.md` & `argrelay-0.1.0.dev3/docs/dev_notes/release_procedure.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/screencast_notes.md` & `argrelay-0.1.0.dev3/docs/dev_notes/screencast_notes.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/scripts_summary.md` & `argrelay-0.1.0.dev3/docs/dev_notes/scripts_summary.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/term_dictionary.md` & `argrelay-0.1.0.dev3/docs/dev_notes/term_dictionary.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/testing_guidelines.md` & `argrelay-0.1.0.dev3/docs/dev_notes/testing_guidelines.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/top_todos.md` & `argrelay-0.1.0.dev3/docs/dev_notes/top_todos.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/ui_tests_notes.md` & `argrelay-0.1.0.dev3/docs/dev_notes/ui_tests_notes.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/dev_notes/version_format.md` & `argrelay-0.1.0.dev3/docs/dev_notes/version_format.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_01_89_09_24.tree_path_selecting_interp.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_01_89_09_24.tree_path_selecting_interp.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_06_99_43_60.list_arg_value.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_06_99_43_60.list_arg_value.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_13_51_07_97.singled_out_implicit_values.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_13_51_07_97.singled_out_implicit_values.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_16_07_78_84.conf_dir_priority.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_16_07_78_84.conf_dir_priority.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_23_62_89_43.tangent_arg_value_completion.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_23_62_89_43.tangent_arg_value_completion.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_24_50_40_64.arg_types_without_envelope_classes.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_24_50_40_64.arg_types_without_envelope_classes.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_29_54_67_86.dir_structure.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_29_54_67_86.dir_structure.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_31_70_49_15.search_control.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_31_70_49_15.search_control.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_37_57_36_29.envelopes_and_payloads.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_37_57_36_29.envelopes_and_payloads.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_41_40_39_44.suggest_from_tree_path.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_41_40_39_44.suggest_from_tree_path.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_42_76_93_51.very_first_or_zero_arg_mapping_interp.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_42_76_93_51.very_first_or_zero_arg_mapping_interp.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_55_57_45_04.demo_logic.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_55_57_45_04.demo_logic.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_58_61_77_69.dev_shell.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_58_61_77_69.dev_shell.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_62_25_92_06.assigned_context.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_62_25_92_06.assigned_context.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_71_87_33_52.help_hint.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_71_87_33_52.help_hint.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_72_40_53_00.fill_control.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_72_40_53_00.fill_control.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_82_35_57_62.envelope_relationship_data_design.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_82_35_57_62.envelope_relationship_data_design.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_85_33_46_53.bootstrap_dev_env.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_85_33_46_53.bootstrap_dev_env.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/feature_stories/FS_90_48_11_45.force_assignment_from_entire_type_value_space.md` & `argrelay-0.1.0.dev3/docs/feature_stories/FS_90_48_11_45.force_assignment_from_entire_type_value_space.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/known_issues/KI_51_67_38_37.impossible_arg_combinations.md` & `argrelay-0.1.0.dev3/docs/known_issues/KI_51_67_38_37.impossible_arg_combinations.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/known_issues/KI_80_82_13_35.option_list_on_describe_with_prefix.md` & `argrelay-0.1.0.dev3/docs/known_issues/KI_80_82_13_35.option_list_on_describe_with_prefix.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/readme.md` & `argrelay-0.1.0.dev3/docs/readme.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/test_data/TD_27_59_80_86.single_data_envelope_arg_suggestion_and_consumption.md` & `argrelay-0.1.0.dev3/docs/test_data/TD_27_59_80_86.single_data_envelope_arg_suggestion_and_consumption.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/test_data/TD_63_37_05_36.demo_services_data.md` & `argrelay-0.1.0.dev3/docs/test_data/TD_63_37_05_36.demo_services_data.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/docs/test_data/TD_70_69_38_46.no_data.md` & `argrelay-0.1.0.dev3/docs/test_data/TD_70_69_38_46.no_data.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/readme.md` & `argrelay-0.1.0.dev3/readme.md`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/setup.py` & `argrelay-0.1.0.dev3/setup.py`
...
### Comparing `argrelay-0.1.0.dev2/src/argrelay/client_command_local/AbstractLocalClientCommand.py` & `argrelay-0.1.0.dev3/src/argrelay/client_command_local/AbstractLocalClientCommand.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/client_command_local/DescribeLineArgsLocalClientCommand.py` & `argrelay-0.1.0.dev3/src/argrelay/client_command_local/DescribeLineArgsLocalClientCommand.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/client_command_local/ProposeArgValuesLocalClientCommand.py` & `argrelay-0.1.0.dev3/src/argrelay/client_command_local/ProposeArgValuesLocalClientCommand.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/client_command_local/RelayLineArgsLocalClientCommand.py` & `argrelay-0.1.0.dev3/src/argrelay/client_command_local/RelayLineArgsLocalClientCommand.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/client_command_remote/AbstractRemoteClientCommand.py` & `argrelay-0.1.0.dev3/src/argrelay/client_command_remote/AbstractRemoteClientCommand.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/client_command_remote/DescribeLineArgsRemoteClientCommand.py` & `argrelay-0.1.0.dev3/src/argrelay/client_command_remote/DescribeLineArgsRemoteClientCommand.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/client_command_remote/ProposeArgValuesRemoteClientCommand.py` & `argrelay-0.1.0.dev3/src/argrelay/client_command_remote/ProposeArgValuesRemoteClientCommand.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/client_command_remote/RelayLineArgsRemoteClientCommand.py` & `argrelay-0.1.0.dev3/src/argrelay/client_command_remote/RelayLineArgsRemoteClientCommand.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ/DemoInterpFactory.py` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ/DemoInterpFactory.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ/DemoInterpFactoryConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ/DemoInterpFactoryConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ/GitRepoArgType.py` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ/GitRepoArgType.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ/GitRepoDelegator.py` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ/GitRepoDelegator.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ/GitRepoEntryConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ/GitRepoEntryConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ/GitRepoLoader.py` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ/GitRepoLoader.py`
...
### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ/GitRepoLoaderConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ/GitRepoLoaderConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ/ServiceArgType.py` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ/ServiceArgType.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ/ServiceDelegator.py` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ/ServiceDelegator.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ/ServiceLoader.py` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ/ServiceLoader.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ/ServiceLoaderConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ/ServiceLoaderConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ_res/argrelay_rc.bash` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ_res/argrelay_rc.bash`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ_res/bootstrap_dev_env.bash` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ_res/bootstrap_dev_env.bash`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ_res/dev_shell.bash` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ_res/dev_shell.bash`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/custom_integ_res/init_shell_env.bash` & `argrelay-0.1.0.dev3/src/argrelay/custom_integ_res/init_shell_env.bash`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/enum_desc/ArgSource.py` & `argrelay-0.1.0.dev3/src/argrelay/enum_desc/ArgSource.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/enum_desc/CompType.py` & `argrelay-0.1.0.dev3/src/argrelay/enum_desc/CompType.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/enum_desc/GlobalArgType.py` & `argrelay-0.1.0.dev3/src/argrelay/enum_desc/GlobalArgType.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/enum_desc/RunMode.py` & `argrelay-0.1.0.dev3/src/argrelay/enum_desc/RunMode.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/enum_desc/TermColor.py` & `argrelay-0.1.0.dev3/src/argrelay/enum_desc/TermColor.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/enum_desc/TokenType.py` & `argrelay-0.1.0.dev3/src/argrelay/enum_desc/TokenType.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/handler_request/AbstractServerRequestHandler.py` & `argrelay-0.1.0.dev3/src/argrelay/handler_request/AbstractServerRequestHandler.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/handler_request/DescribeLineArgsServerRequestHandler.py` & `argrelay-0.1.0.dev3/src/argrelay/handler_request/DescribeLineArgsServerRequestHandler.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/handler_request/ProposeArgValuesServerRequestHandler.py` & `argrelay-0.1.0.dev3/src/argrelay/handler_request/ProposeArgValuesServerRequestHandler.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/handler_request/RelayLineArgsServerRequestHandler.py` & `argrelay-0.1.0.dev3/src/argrelay/handler_request/RelayLineArgsServerRequestHandler.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/handler_response/DescribeLineArgsClientResponseHandler.py` & `argrelay-0.1.0.dev3/src/argrelay/handler_response/DescribeLineArgsClientResponseHandler.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/handler_response/RelayLineArgsClientResponseHandler.py` & `argrelay-0.1.0.dev3/src/argrelay/handler_response/RelayLineArgsClientResponseHandler.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/misc_helper/AbstractPlugin.py` & `argrelay-0.1.0.dev3/src/argrelay/misc_helper/AbstractPlugin.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/misc_helper/ElapsedTime.py` & `argrelay-0.1.0.dev3/src/argrelay/misc_helper/ElapsedTime.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/misc_helper/TypeDesc.py` & `argrelay-0.1.0.dev3/src/argrelay/misc_helper/TypeDesc.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/misc_helper/__init__.py` & `argrelay-0.1.0.dev3/src/argrelay/misc_helper/__init__.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/mongo_data/MongoClientWrapper.py` & `argrelay-0.1.0.dev3/src/argrelay/mongo_data/MongoClientWrapper.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/mongo_data/MongoServerWrapper.py` & `argrelay-0.1.0.dev3/src/argrelay/mongo_data/MongoServerWrapper.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_delegator/AbstractDelegator.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_delegator/AbstractDelegator.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_delegator/ErrorDelegator.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_delegator/ErrorDelegator.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_delegator/ErrorDelegatorCustomDataSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_delegator/ErrorDelegatorCustomDataSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_delegator/HelpDelegator.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_delegator/HelpDelegator.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_delegator/InterceptDelegator.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_delegator/InterceptDelegator.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_delegator/InvocationInput.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_delegator/InvocationInput.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_delegator/NoopDelegator.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_delegator/NoopDelegator.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_interp/AbstractInterp.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_interp/AbstractInterp.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_interp/FirstArgInterp.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_interp/FirstArgInterp.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_interp/FirstArgInterpFactory.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_interp/FirstArgInterpFactory.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_interp/FirstArgInterpFactoryConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_interp/FirstArgInterpFactoryConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_interp/FuncArgsInterp.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_interp/FuncArgsInterp.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_interp/FuncArgsInterpFactory.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_interp/FuncArgsInterpFactory.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_interp/NoopInterp.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_interp/NoopInterp.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_interp/NoopInterpFactory.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_interp/NoopInterpFactory.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_interp/TreePathInterp.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_interp/TreePathInterp.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_interp/TreePathInterpFactory.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_interp/TreePathInterpFactory.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_interp/TreePathInterpFactoryConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_interp/TreePathInterpFactoryConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_loader/HelpLoader.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_loader/HelpLoader.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/plugin_loader/InterceptLoader.py` & `argrelay-0.1.0.dev3/src/argrelay/plugin_loader/InterceptLoader.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_client/AbstractClient.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_client/AbstractClient.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_client/AbstractClientCommandFactory.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_client/AbstractClientCommandFactory.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_client/LocalClient.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_client/LocalClient.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_client/LocalClientCommandFactory.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_client/LocalClientCommandFactory.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_client/RemoteClient.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_client/RemoteClient.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_client/RemoteClientCommandFactory.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_client/RemoteClientCommandFactory.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_client/__main__.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_client/__main__.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_server/CustomFlaskApp.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_server/CustomFlaskApp.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_server/HelpHintCache.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_server/HelpHintCache.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_server/LocalServer.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_server/LocalServer.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_server/QueryEngine.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_server/QueryEngine.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_server/QueryResult.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_server/QueryResult.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_server/gui_static/argrelay_client.js` & `argrelay-0.1.0.dev3/src/argrelay/relay_server/gui_static/argrelay_client.js`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_server/gui_static/argrelay_style.css` & `argrelay-0.1.0.dev3/src/argrelay/relay_server/gui_static/argrelay_style.css`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_server/gui_templates/argrelay_main.html` & `argrelay-0.1.0.dev3/src/argrelay/relay_server/gui_templates/argrelay_main.html`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_server/route_api.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_server/route_api.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/relay_server/route_gui.py` & `argrelay-0.1.0.dev3/src/argrelay/relay_server/route_gui.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/runtime_context/EnvelopeContainer.py` & `argrelay-0.1.0.dev3/src/argrelay/runtime_context/EnvelopeContainer.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/runtime_context/InputContext.py` & `argrelay-0.1.0.dev3/src/argrelay/runtime_context/InputContext.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/runtime_context/InterpContext.py` & `argrelay-0.1.0.dev3/src/argrelay/runtime_context/InterpContext.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/runtime_context/ParsedContext.py` & `argrelay-0.1.0.dev3/src/argrelay/runtime_context/ParsedContext.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/runtime_context/SearchControl.py` & `argrelay-0.1.0.dev3/src/argrelay/runtime_context/SearchControl.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/runtime_data/ServerConfig.py` & `argrelay-0.1.0.dev3/src/argrelay/runtime_data/ServerConfig.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/runtime_data/StaticData.py` & `argrelay-0.1.0.dev3/src/argrelay/runtime_data/StaticData.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/sample_conf/argrelay.server.yaml` & `argrelay-0.1.0.dev3/src/argrelay/sample_conf/argrelay.server.yaml`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_core_client/ClientConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_core_client/ClientConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_core_client/ConnectionConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_core_client/ConnectionConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_core_server/GuiBannerConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_core_server/GuiBannerConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_core_server/MongoClientConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_core_server/MongoClientConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_core_server/MongoConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_core_server/MongoConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_core_server/MongoServerConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_core_server/MongoServerConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_core_server/QueryCacheConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_core_server/QueryCacheConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_core_server/ServerConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_core_server/ServerConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_core_server/StaticDataSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_core_server/StaticDataSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_interp/DataEnvelopeSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_interp/DataEnvelopeSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_interp/FuncArgsInterpConfigSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_interp/FuncArgsInterpConfigSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_interp/FunctionEnvelopeInstanceDataSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_interp/FunctionEnvelopeInstanceDataSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_interp/InitControlSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_interp/InitControlSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_interp/SearchControlSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_interp/SearchControlSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_config_plugin/PluginEntrySchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_config_plugin/PluginEntrySchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_request/RequestContextSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_request/RequestContextSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_response/ArgValuesSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_response/ArgValuesSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_response/AssignedValueSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_response/AssignedValueSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_response/EnvelopeContainerSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_response/EnvelopeContainerSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_response/FilteredDict.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_response/FilteredDict.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_response/InterpResult.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_response/InterpResult.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_response/InterpResultSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_response/InterpResultSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/schema_response/InvocationInputSchema.py` & `argrelay-0.1.0.dev3/src/argrelay/schema_response/InvocationInputSchema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/server_spec/DescribeLineArgsSpec.py` & `argrelay-0.1.0.dev3/src/argrelay/server_spec/DescribeLineArgsSpec.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/server_spec/ProposeArgValuesSpec.py` & `argrelay-0.1.0.dev3/src/argrelay/server_spec/ProposeArgValuesSpec.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/server_spec/RelayLineArgsSpec.py` & `argrelay-0.1.0.dev3/src/argrelay/server_spec/RelayLineArgsSpec.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/server_spec/const_int.py` & `argrelay-0.1.0.dev3/src/argrelay/server_spec/const_int.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/server_spec/server_data_schema.py` & `argrelay-0.1.0.dev3/src/argrelay/server_spec/server_data_schema.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/test_helper/EnvMockBuilder.py` & `argrelay-0.1.0.dev3/src/argrelay/test_helper/EnvMockBuilder.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/test_helper/InOutTestCase.py` & `argrelay-0.1.0.dev3/src/argrelay/test_helper/InOutTestCase.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/test_helper/OpenFileMock.py` & `argrelay-0.1.0.dev3/src/argrelay/test_helper/OpenFileMock.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay/test_helper/__init__.py` & `argrelay-0.1.0.dev3/src/argrelay/test_helper/__init__.py`

 * *Files identical despite different names*

### Comparing `argrelay-0.1.0.dev2/src/argrelay.egg-info/PKG-INFO` & `argrelay-0.1.0.dev3/src/argrelay.egg-info/PKG-INFO`
...
### Comparing `argrelay-0.1.0.dev2/src/argrelay.egg-info/SOURCES.txt` & `argrelay-0.1.0.dev3/src/argrelay.egg-info/SOURCES.txt`
